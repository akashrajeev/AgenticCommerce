...
type JudgePayload = { generatedAt: string; testMode: boolean; checks: Check[]; metrics: { authorizedTransactions: number; confirmedTransactions: number; merchantOrders: number; razorpayVerifiedPayments: number; protocolCount: number; growthUpliftPaise: number }; links: Record<string, string> };
