...
test("supports stateless 2026 discover and tool listing", async () => {
  ...
  assert.deepEqual(names, ["mandate_razorpay_create_order", "mandate_razorpay_fetch_order", "mandate_razorpay_fetch_payment", "mandate_razorpay_capture_payment", "mandate_razorpay_verify_settlement", "mandate_razorpay_explain_transaction", "mandate_campaign_payment_evidence"]);
