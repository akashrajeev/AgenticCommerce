...
type Candidate = { transactionId: string; authorizationId: string; productId: string | null; amountPaise: number | null; state: string; razorpayOrderId: string | null };
type Result = Candidate & { ok: boolean; body?: unknown; error?: string };
type Payload = { testModeOnly: boolean; campaign: Campaign; campaigns: Campaign[]; candidates: Candidate[]; maxBatchSize: number; executionRule: string };
