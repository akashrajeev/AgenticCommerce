...
export const catalog: Product[] = [
  ...
  },
  {
    ...
    specifications: { switches: "linear", layout: "TKL", connectivity: "USB-C + 2.4GHz" },
  ...
  },
  {
    ...
    specifications: { sensor: "26,000 DPI", batteryHours: "70", connectivity: "2.4GHz + Bluetooth" },
  ...
  },
  {
    ...
    specifications: { resolution: "2560x1440", refreshRate: "165Hz", panel: "IPS", size: "27-inch" },
  ...
  },
  {
    ...
    specifications: { resolution: "4K", framerate: "30fps", focus: "autofocus", fieldOfView: "90°" },
  ...
  },
  {
    ...
    specifications: { display: "1.5-inch AMOLED", batteryDays: "7", gps: "dual-band", waterResistance: "5ATM" },
...
export function buildQuote(product: Product, quantity: number): CheckoutQuote {
